...
describe('NotificationsComponent: ', () => {
  ...
  describe('Properties of "NotificationsItemComponent": ', () => {
    ...
    it('element with class "notifications-item__link" should haveh attribute href equal to link value of component property', () => {
      let linkAttr = fixture.debugElement.query(By.css('.notifications-item__link')).nativeElement.getAttribute('href');

      expect(linkAttr).toEqual(comp.notificationsData[0].link);
    });
